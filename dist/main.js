...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _folder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./folder */ \"./src/folder.js\");\n\n\nconst todoDependencies = (() => {\n  const defaultFolder = new _folder__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Default');\n  const folders = [defaultFolder];\n\n  let currentFolder;\n\n  return {\n    folders,\n    defaultFolder,\n    currentFolder,\n  };\n})();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (todoDependencies);\n\n\n//# sourceURL=webpack://todo-list/./src/dependencies.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"displayList\": () => (/* binding */ displayList),\n/* harmony export */   \"nameOfListToDisplay\": () => (/* binding */ nameOfListToDisplay)\n/* harmony export */ });\n/* harmony import */ var _dependencies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dependencies */ \"./src/dependencies.js\");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ \"./src/helpers.js\");\n\n\n\nfunction listElemExists(page) {\n  const contentDiv = document.querySelector('#content');\n  return `list-${page}` in contentDiv.children;\n}\n\nfunction displayList(listToDisplay, page) {\n  if (!listElemExists(page)) {\n    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadElemToContainer)('#content', 'div', `list-${page}`);\n  }\n\n  for (let i = 0; i < listToDisplay.length; i += 1) {\n    const item = listToDisplay[i];\n\n    let name;\n    if (page === 'home') {\n      name = item.name;\n    } else if (page === 'folder') {\n      name = item.title;\n    }\n    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadElemToContainer)(`#list-${page}`, 'div', `list-${page}-${name}-div`);\n    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadElemToContainer)(\n      `#list-${page}-${name}-div`,\n      'span',\n      `list-${page}-${name}-text`\n    );\n    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.addTextToElem)(`#list-${page}-${name}-text`, `${name}`);\n    if (!(item.name === 'Default' && page === 'home')) {\n      (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadElemToContainer)(\n        `#list-${page}-${name}-div`,\n        'button',\n        `list-${page}-${name}-del-btn`\n      );\n      (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.addTextToElem)(`#list-${page}-${name}-del-btn`, 'DEL');\n    }\n  }\n}\n\nfunction nameOfListToDisplay(folderName, page) {\n  _dependencies__WEBPACK_IMPORTED_MODULE_0__[\"default\"].folders.forEach((currentFolder) => {\n    if (currentFolder.name === folderName) {\n      displayList(currentFolder.folder, page);\n    }\n  });\n}\n\n\n\n\n//# sourceURL=webpack://todo-list/./src/display-helpers.js?");

/***/ }),

/***/ "./src/folder-helpers.js":
/*!*******************************!*\
  !*** ./src/folder-helpers.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createFolder\": () => (/* binding */ createFolder),\n/* harmony export */   \"deleteFolder\": () => (/* binding */ deleteFolder),\n/* harmony export */   \"listOfTodosToDisplay\": () => (/* binding */ listOfTodosToDisplay)\n/* harmony export */ });\n/* harmony import */ var _folder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./folder */ \"./src/folder.js\");\n/* harmony import */ var _dependencies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dependencies */ \"./src/dependencies.js\");\n/* harmony import */ var _display_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display-helpers */ \"./src/display-helpers.js\");\n/* harmony import */ var _todo_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todo-helpers */ \"./src/todo-helpers.js\");\n\n\n\n\n\nfunction createFolder(name) {\n  _dependencies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].folders.push(new _folder__WEBPACK_IMPORTED_MODULE_0__[\"default\"](name));\n}\n\nfunction deleteFolder(folderToRemove) {\n  _dependencies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].folders.forEach((currentFolder) => {\n    if (currentFolder.name === folderToRemove) {\n      // Delete todos from Default too\n      const folderLength = currentFolder.folder.length;\n      for (let i = 0; i < folderLength; i += 1) {\n        (0,_todo_helpers__WEBPACK_IMPORTED_MODULE_3__.deleteTodo)(\n          currentFolder.folder[0].title,\n          currentFolder.folder[0].dueDate,\n          currentFolder.folder[0].priority\n        );\n      }\n\n      const index = _dependencies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].folders.indexOf(currentFolder);\n      _dependencies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].folders.splice(index, 1);\n    }\n  });\n}\n\nfunction listOfTodosToDisplay(folderName) {\n  _dependencies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].folders.forEach((currentFolder) => {\n    if (currentFolder.name === folderName) {\n      (0,_display_helpers__WEBPACK_IMPORTED_MODULE_2__.displayList)(currentFolder.folder, 'folder');\n    }\n  });\n}\n\n\n\n\n//# sourceURL=webpack://todo-list/./src/folder-helpers.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _reset_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reset.css */ \"./src/reset.css\");\n/* harmony import */ var _dependencies__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dependencies */ \"./src/dependencies.js\");\n/* harmony import */ var _todo_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todo-list */ \"./src/todo-list.js\");\n/* harmony import */ var _todo_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./todo-helpers */ \"./src/todo-helpers.js\");\n/* harmony import */ var _folder_helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./folder-helpers */ \"./src/folder-helpers.js\");\n\n\n\n\n\n\n\nconst app = new _todo_list__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n\n// Manual folders\n// createFolder('Groceries');\n// createFolder('Liquour');\n// createFolder('Waters');\n// Manual folders & todos\n(0,_folder_helpers__WEBPACK_IMPORTED_MODULE_5__.createFolder)('Groceries');\n(0,_todo_helpers__WEBPACK_IMPORTED_MODULE_4__.createTodo)('Kale', '2lbs of kale', '2022-12-25', 1, 'Groceries');\n(0,_todo_helpers__WEBPACK_IMPORTED_MODULE_4__.createTodo)('Chili', 'a 32oz bottle of valentina', '2023-01-10', 1, 'Groceries');\n(0,_folder_helpers__WEBPACK_IMPORTED_MODULE_5__.createFolder)('Liquour');\n(0,_todo_helpers__WEBPACK_IMPORTED_MODULE_4__.createTodo)('Lighter', 'a fancy big flame lighter', '2022-12-30', 1, 'Liquour');\n(0,_folder_helpers__WEBPACK_IMPORTED_MODULE_5__.createFolder)('Waters');\n// Home Page\napp.homePage();\n\n// Manual Todo's\n// createTodo('Refrigerator', 'Three door fridge', '2022-12-25', 1);\n// createTodo('Microwave', 'Small microwave', '2023-01-10', 1);\n// createTodo('Shaker', '1 liter smoothie shaker', '2022-12-30', 1);\n// Folder Page, making todo's clickable\n// app.folderPage('Default');\n\n// Todo Page\n// app.todoPage(todoObj('Microwave'));\n\n// Just test logging results\nconsole.log(_dependencies__WEBPACK_IMPORTED_MODULE_2__[\"default\"].defaultFolder, 'default folders');\nconsole.log(_dependencies__WEBPACK_IMPORTED_MODULE_2__[\"default\"].folders, 'folders');\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
